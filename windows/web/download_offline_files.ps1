...
Download-File -Uri "https://github.com/SlimeVR/SlimeVR-Server/releases/download/v0.6.3/SlimeVR-win64.zip" -OutFile "$DownloadDir\SlimeVR-win64.zip"
...
Download-File -Uri "https://github.com/SlimeVR/SlimeVR-OpenVR-Driver/releases/download/v0.2.1/slimevr-openvr-driver-win64.zip" -OutFile "$DownloadDir\slimevr-openvr-driver-win64.zip"
Download-File -Uri "https://github.com/SlimeVR/SlimeVR-Feeder-App/releases/download/v0.2.7/SlimeVR-Feeder-App-win64.zip" -OutFile "$DownloadDir\SlimeVR-Feeder-App-win64.zip"